...
def scoap(circuit_file):
    ...
    # cc0 qnd cc1 for 8 input and gate
    ...
    # cc0 qnd cc1 for 9 input and gate
    ...
    # cc0 qnd cc1 for 8 input nand gate
    ...
    # cc0 qnd cc1 for 2 input xor gate
    ...
    # co for 2 input and gate
    def and2co(zco,acc1,bcc1):
        a=zco+bcc1+1
        b=zco+acc1+1
        return a,b

    # co for 3 input and gate
    ...
    # co for 2 input or gate
    def or2co(zco,acc0,bcc0):
        a=zco+bcc0+1
        b=zco+acc0+1
        return a,b

    # co for 3 input or gate
