def logic(circuit_file,input_bit):
    # logic value for 2 input and gate
    def and2(pa,pb):
        out = pa and pb
        if out==True:
            return 1
    ...
    # logic value for 2 input nand gate
    def nand2(pa,pb):
        out = not(pa and pb)
        if out==True:
            return 1
    ...
    # logic value for 3 input nand gate
    def nand3(pa,pb,pc):
    ...
    # logic value for 4 input nand gate
    ...
    # logic value for 5 input nand gate
    ...
    # logic value for 8 input nand gate
    ...
    # logic value for buffer gate
    def buf1(pa):
        return pa

    # logic value for 2 input nor gate
    def nor2(pa,pb):
        out = not (pa or pb)
        if out==True:
            return 1
    ...
    # logic value for 3 input nor gate
    def nor3(pa,pb,pc):
    ...
    # logic value for 4 input nor gate
    ...
    # logic value for 8 input nor gate
    ...
    # logic value for 2 input or gate
    def or2(pa,pb):
        out = (pa or pb)
        if out==True:
            return 1
    ...
    # logic value for 3 input or gate
    def or3(pa,pb,pc):
        out =  (pa or pb or pc)
        if out==True:
            return 1
    ...
    # logic value for 2 input xor gate
    def xor2(pa,pb):
    ...
    # logic value for 3 input and gate
    def and3(pa,pb,pc):
    ...
    # logic value for 4 input and gate
    ...
    # logic value for 4 input or gate
    def or4(pa,pb,pc,pd):
    ...
    # logic value for 5 input or gate
    ...
    # logic value for 5 input and gate
    ...
    # logic value for 8 input and gate
    ...
    # logic value for 9 input and gate
    ...
    return inp_logic,out_logic,wire_logic